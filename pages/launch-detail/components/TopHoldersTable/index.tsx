          ...
          <table className="w-full min-w-[600px]">
            <thead>
              <tr className="text-left border-b-2 border-[#202020]">
                <th className="py-2 sm:py-4 px-3 sm:px-6 font-gliker text-[#4D4D4D] text-xs sm:text-base">Rank</th>
                <th className="py-2 sm:py-4 px-3 sm:px-6 font-gliker text-[#4D4D4D] text-xs sm:text-base">Address</th>
            ...
            <tbody className="divide-y divide-[#4D4D4D]/10">
              {!holders.length ? (
                <tr className="hover:bg-white border-white h-full">
                  <td colSpan={4} className="h-24 text-center text-black text-xs sm:text-base">
                    No results.
                  </td>
                </tr>
              ) : (
                  ...
                  >
                    ...
                    <td className="py-2 sm:py-4 px-3 sm:px-6 text-xs sm:text-base">
                      <div className="flex items-center gap-1 sm:gap-2">
                        {holder.address.toLowerCase() === projectPool?.address.toLowerCase() ? (
                        ...
                        ) : holder.address.toLowerCase() === projectPool?.provider.toLowerCase() ? (
                          <span className="text-black flex items-center gap-1 sm:gap-2">
                            <Image
                              width={12}
                              height={12}
